...
#         evidence = (FxCb=="Fixed-Price") & (Comp=="Comp."))
# 
# gin1.find <- setFinding(compGin, nodes = c("Comp","FxCb"),
#                         states = c( "Comp.","Fixed-Price"))
# 
# gin1.find <- setFinding(compGin, nodes = c("Comp","FxCb"),
#                         states = c( "Comp.","Fixed-Price"))
# 
# sapply(levels(ContractModel$Ceil),function(x) data.frame(nodes = c("Comp","FxCb","Ceil"),
...
# querygrain(gin1.find, nodes = c("Offr"))
```
