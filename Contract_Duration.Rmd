...
CompleteContract$qDuration<-factor(CompleteContract$qDuration,
...
ContractComplete$qDuration<-cut2(ContractComplete$UnmodifiedDays,cuts=c(61,214,366,732))
...
ggplot(data = ContractSurvival,
    ...
    geom_bar(stat="identity",subset=.(IsTerminated=="Terminated"),aes(y=SumofObligatedAmount*(-1)))+
    coord_flip()
