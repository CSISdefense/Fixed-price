...
* Cei (qCeiling) qCeiling has (`r sprintf("%1.2f%%",nrow(subset(ContractSample,is.na(UnmodifiedContractBaseAndAllOptionsValue)|UnmodifiedContractBaseAndAllOptionsValue=="Unlabeled")) /nrow(ContractSample)*100)` missing data.
