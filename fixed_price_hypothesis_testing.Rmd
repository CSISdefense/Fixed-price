...
AircraftFind<- setEvidence(FixedPriceGin, 
                           nodes=c("What"),
...
#Single Offer Competition
ggplot(subset(RnDlongDF,dVariable=="% Single Offer Competition"),
...
#Expected Number of Offers
ggplot(subset(RnDlongDF,dVariable=="Average Number of Offers for Competed Contracts"),
...
#Expected Number of Changes
ggplot(subset(RnDlongDF,dVariable=="Average Number of Change Orders"),
       aes(x=Control,color=FxCb,shape=FxCb,y=Average)
       )+
    geom_point()+
...
#Ceiling Raising Change Orders %
ggplot(subset(RnDlongDF,dVariable=="Ceiling Raising Change Orders %"),
        aes(x=Control,color=FxCb,shape=FxCb,y=Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())
...
#Terminations
ggplot(subset(RnDlongDF,dVariable=="Terminated"),
...
RnDdf$Hypothesis<-factor(RnDdf$Hypothesis,levels=c("R&D","Population"),ordered=TRUE)

#Single Offer Competition
ggplot(subset(RnDdf,dVariable=="% Single Offer Competition"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
#Expected Number of Offers
ggplot(subset(RnDdf,dVariable=="Average Number of Offers for Competed Contracts"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
#Expected Number of Changes
ggplot(subset(RnDdf,dVariable="Average Number of Change Orders"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
NotMDAPFind<- setEvidence(FixedPriceGin, 
                             nodes=c("MDAP"),
                             states=c("No label"))


getEvidence(MDAPFind)



MDAPdf<-FixedPriceHypothesisTester(MDAPFind,"MDAP")
MDAPdf<-rbind(MDAPdf,
                  FixedPriceHypothesisTester(FixedPriceGin,"Population")
                  )
MDAPdf$Hypothesis<-factor(MDAPdf$Hypothesis,levels=c("MDAP","Population"),ordered=TRUE)

#Remove redundant tests
MDAPdf<-subset(MDAPdf,
                   !Control %in% unique(MDAPdf$Hypothesis))


#Single Offer Competition
ggplot(subset(MDAPdf,dVariable=="% Single Offer Competition"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
#Expected Number of Offers
ggplot(subset(MDAPdf,dVariable=="Average Number of Offers for Competed Contracts"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
#Expected Number of Changes
ggplot(subset(MDAPdf,dVariable="Average Number of Change Orders"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
#Ceiling Raising Change Orders %
ggplot(subset(MDAPdf,dVariable=="Ceiling Raising Change Orders %"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
...
#Terminations
ggplot(subset(MDAPdf,dVariable=="Terminated"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=1))  
