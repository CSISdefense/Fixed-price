...
OffersSizeDF<-OffersHypothesisTester(compGin)
...
# debug(ChangeOrdersHypothesisTester)
ChangeOrderSizeDF<-ChangeOrdersHypothesisTester(compGin)
#No redundant tests to remove

# color=Control,shape=Control
ggplot(ChangeOrderSizeDF,
       aes(x=CrossTab,y=FixedCostMargin)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()
