...
SmallCeilFind<-ContractHypothesisTester(SmallCeilFind)
...
NotSmallCeilFind<-ContractHypothesisTester(NotSmallCeilFind)
...
VerySmallCeilFind<-ContractHypothesisTester(VerySmallCeilFind)
...
NotVerySmallCeilFind<- setEvidence(compGin, 
                                   nodes=c("Ceil"),
                                   states=c(list(
                                       levels(compGin[[1]]$levels$Ceil)[levels(compGin[[1]]$levels$Ceil)!=c("[0,15k)")]))
                                   )

getEvidence(NotVerySmallCeilFind)
NotVerySmallCeilFind<-ContractHypothesisTester(NotVerySmallCeilFind)
...
NotUnder1mCeilFind<-ContractHypothesisTester(NotUnder1mCeilFind)
