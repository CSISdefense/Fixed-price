...
MDAPlongDF<-FixedPriceComparisonTable(subset(ModelSummary,PSR=="MDAP"),
                                "Labeled MDAP")
...
RnDwideDF<-FixedPriceCast(rbind(MDAPlongDF,PopulationLongDF))
...
LongDurLongDF<-FixedPriceComparisonTable(subset(ModelSummary,PSR=="Dur"),
                                "(~2 years+]")




LongDurLongDF$Hypothesis<-factor(LongDurLongDFf$Hypothesis,levels=c("Long Dur.","Population"),ordered=TRUE)
...
#Single Offer Competition
ggplot(subset(LongDurLongDF,dVariable=="% Single Offer Competition"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_p)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Average Number of Offers
ggplot(subset(LongDurLongDF,dVariable=="Average Number of Offers for Competed Contracts"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Average Number of Changes
ggplot(subset(LongDurLongDF,dVariable="Average Number of Change Orders"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Ceiling Raising Change Orders %
ggplot(subset(LongDurLongDF,dVariable=="Ceiling Raising Change Orders %"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Terminations
ggplot(subset(LongDurLongDF,dVariable=="Terminated"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_p)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
LongDurWideDF$Hypothesis<-factor(LongDurWideDFf$Hypothesis,levels=c("Long Dur.","Population"),ordered=TRUE)
...
CompLongDF<-FixedPriceHypothesisTester(CompFind,"Comp.")
CompLongDF<-rbind(CompLongDF,
              FixedPriceHypothesisTester(FixedPriceGin,"Population")
              )


CompLongDF$Hypothesis<-factor(CompLongDF$Hypothesis,levels=c("Comp.","Population"),ordered=TRUE)
...
#Average Number of Changes
ggplot(subset(CompLongDF,dVariable="Average Number of Change Orders"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Ceiling Raising Change Orders %
ggplot(subset(CompLongDF,dVariable=="Ceiling Raising Change Orders %"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Terminations
ggplot(subset(CompLongDF,dVariable=="Terminated"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_p)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
LongDurwideDF<-FixedPriceCast(rbind(LongDurlongDF,
                                    subset(PopulationLongDF,Comp=="Comp."))
...
SoftwareLongDF<-FixedPriceHypothesisTester(SoftwareFind,"Possible Software Eng.")
SoftwareLongDF<-rbind(SoftwareLongDF,
                  FixedPriceHypothesisTester(FixedPriceGin,"Population")
                  )
...
#Single Offer Competition
ggplot(subset(SoftwareLongDF,dVariable=="% Single Offer Competition"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_p)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Average Number of Offers
ggplot(subset(SoftwareLongDF,dVariable=="Average Number of Offers for Competed Contracts"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Average Number of Changes
ggplot(subset(SoftwareLongDF,dVariable="Average Number of Change Orders"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Ceiling Raising Change Orders %
ggplot(subset(SoftwareLongDF,dVariable=="Ceiling Raising Change Orders %"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_Average)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
#Terminations
ggplot(subset(SoftwareLongDF,dVariable=="Terminated"),
       aes(x=Control,color=Hypothesis,shape=Hypothesis,y=FixedCostMargin_p)
       )+
    geom_point()+
    facet_grid(dVariable~iVariable)+ coord_flip()+theme(legend.position="bottom",axis.text.x = element_text(angle = 90, hjust = 1))+ scale_y_continuous(labels = percent_format())+geom_hline(aes(yintercept=0))  
...
SoftwareWideDF<-FixedPriceHypothesisTester(SoftwareFind,"Possible Software Eng.")
SoftwareWideDF<-rbind(SoftwareWideDF,
                  FixedPriceHypothesisTester(FixedPriceGin,"Population")
                  )


SoftwareWideDF$Hypothesis<-factor(SoftwareWideDF$Hypothesis,levels=c("Comp.","Possible Software Eng."),ordered=TRUE)
