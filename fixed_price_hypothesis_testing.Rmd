...
PointRowWrapper(NULL,#VAR.main.label,
                "All Contracts (Overall and Controls)",          #VAR.row.label,
...
PointRowWrapper(NULL,#VAR.main.label,
                "All Contracts (Overall and Controls)",          #VAR.row.label,
                "% Difference Between Fixed Price and Cost-Based Single Offer Competition Rate",          #VAR.data.label,
                "Contract Sample",          #VAR.color.legend.label,
                "Significance of Difference between\nFixed Price and Cost-Based",         #VAR.size.legend.label,
                Coloration,#VAR.Coloration
    subset(PopulationWideDF,dVariable=="% Single Offer Competition" & FxCb!="Combination or Other"),
                          "Control",
                          "FixedCostMargin_p",
                          "Hypothesis",
...
PointRowWrapper(NULL,#VAR.main.label,
                "All Contracts (Overall and Controls)",          #VAR.row.label,
                "% Difference Between Fixed Price and Cost-Based Approximate Average Number of Offers",   #VAR.data.label,
                "Contract Sample",          #VAR.color.legend.label,
                "Significance of Difference between\nFixed Price and Cost-Based",         #VAR.size.legend.label,
                Coloration,#VAR.Coloration
...
PointRowWrapper(NULL,#VAR.main.label,
                "All Contracts (Overall and Controls)",          #VAR.row.label,
                "% Difference Between Fixed Price and Cost-Based Approximate Average Number of Change Orders",          #VAR.data.label,
                "Contract Sample",          #VAR.color.legend.label,
                "Significance of Difference between\nFixed Price and Cost-Based",         #VAR.size.legend.label,
                Coloration,#VAR.Coloration
...
PointRowWrapper(NULL,#VAR.main.label,
                "All Contracts (Overall and Controls)",          #VAR.row.label,
                "% Difference Between Fixed Price and Cost-Based Approximate Average Ceiling Raising Change Orders",          #VAR.data.label,
                "Contract Sample",          #VAR.color.legend.label,
                "Significance of Difference between\nFixed Price and Cost-Based",         #VAR.size.legend.label,
                Coloration,#VAR.Coloration
...
PointRowWrapper(NULL,#VAR.main.label,
                "All Contracts (Overall and Controls)",          #VAR.row.label,
                "% Difference Between Fixed Price and Cost-Based Terminated Contracts Rate",          #VAR.data.label,
                "Contract Sample",          #VAR.color.legend.label,
                "Significance of Difference between\nFixed Price and Cost-Based",         #VAR.size.legend.label,
                Coloration,#VAR.Coloration
