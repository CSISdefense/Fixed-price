...
output<-data.frame(rbind(
    c(Control="Under1mCeil-All",unlist(querygrain(Under1mCeilFind,"Offr"))),
      c(Control="!Under1mCeil-All",unlist(querygrain(NotUnder1mCeilFind,"Offr"))),
      c(Control="Under1mCeil-Comp",unlist(querygrain(Under1mCeilCompFind,"Offr"))),
      c(Control="!Under1mCeil-Comp",unlist(querygrain(NotUnder1mCeilCompFind,"Offr")))
))
output$Offr.1<-as.numeric(as.character(output$Offr.1))
output$Offr.2<-as.numeric(as.character(output$Offr.2))
output$Offr.3.4<-as.numeric(as.character(output$Offr.3.4))
