...
ContractWL<-rbind(ContractWL,data.frame(from="MDAP",to="Term")) #Covering all hypotheses and controls
...
ContractWL<-rbind(ContractWL,data.frame(from="UCA",to="NChg")) #Covering all hypotheses and controls
...
FixedPriceGin <- grain(as.graphNEL(FixedPriceNetwork), data=ContractModel, smooth = 0.0000001)
