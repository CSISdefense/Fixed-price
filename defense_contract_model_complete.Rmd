...
```{r DetailCustomer}
# defense_contract_SP_ContractCompleteContractsDetailsCustomer
CompleteContracts <-read.csv(
    paste(Path,"data\\defense_contract_SP_ContractCompleteContractsDetailsCustomer.csv",sep=""),
...
CompleteContracts<-standardize_variable_names(CompleteContracts)
...
CompleteContracts$ObligatedAmountIsInternational<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsInternational))[
        CompleteContracts$ObligatedAmountIsInternational]
...
CompleteContracts$AnyInternational[CompleteContracts$pIsInternational<=0 & 
                                       CompleteContracts$AnyInternational=="Any\nInternational" &
...
CompleteContracts$qDuration<-cut2(CompleteContracts$UnmodifiedDays,cuts=c(61,214,366))
...
CompleteContracts$ObligatedAmountIsProducts<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsProducts))[
        CompleteContracts$ObligatedAmountIsProducts]

CompleteContracts$ObligatedAmountIsServices<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsServices))[
        CompleteContracts$ObligatedAmountIsServices]

CompleteContracts$ObligatedAmountIsRnD<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsRnD))[
        CompleteContracts$ObligatedAmountIsRnD]
...
CompleteContracts$ObligatedAmountIsLand<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsLand))[
        CompleteContracts$ObligatedAmountIsLand]

CompleteContracts$ObligatedAmountIsVessel<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsVessel))[
        CompleteContracts$ObligatedAmountIsVessel]

CompleteContracts$ObligatedAmountIsAir<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsAir))[
        CompleteContracts$ObligatedAmountIsAir]

CompleteContracts$ObligatedAmountIsOtherPP<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsOtherPP))[
        CompleteContracts$ObligatedAmountIsOtherPP]

CompleteContracts$ObligatedAmountIsWnA<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsWnA))[
        CompleteContracts$ObligatedAmountIsWnA]

CompleteContracts$ObligatedAmountIsMnS<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsMnS))[
        CompleteContracts$ObligatedAmountIsMnS]

CompleteContracts$ObligatedAmountIsEnC<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsEnC))[
        CompleteContracts$ObligatedAmountIsEnC]

CompleteContracts$ObligatedAmountIsFRSnC<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsFRSnC))[
        CompleteContracts$ObligatedAmountIsFRSnC]
...
CompleteContracts$UnmodifiedNumberOfOffersReceived<-
    as.numeric(levels(CompleteContracts$UnmodifiedNumberOfOffersReceived))[
        CompleteContracts$UnmodifiedNumberOfOffersReceived]


CompleteContracts$NumberOfOffersReceived<-
    as.numeric(levels(CompleteContracts$NumberOfOffersReceived))[
        CompleteContracts$NumberOfOffersReceived]
...
CompleteContracts$ObligatedAmountIsArmy<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsArmy))[
        CompleteContracts$ObligatedAmountIsArmy]

CompleteContracts$ObligatedAmountIsNavy<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsNavy))[
        CompleteContracts$ObligatedAmountIsNavy]

CompleteContracts$ObligatedAmountIsAirForce<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsAirForce))[
        CompleteContracts$ObligatedAmountIsAirForce]

CompleteContracts$ObligatedAmountIsOtherDoD<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsOtherDoD))[
        CompleteContracts$ObligatedAmountIsOtherDoD]
...
CompleteContracts$ObligatedAmountIsFixedPrice<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsFixedPrice))[
        CompleteContracts$ObligatedAmountIsFixedPrice]

CompleteContracts$ObligatedAmountIsCostBased<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsCostBased))[
        CompleteContracts$ObligatedAmountIsCostBased]

CompleteContracts$ObligatedAmountIsCombination<-
    as.numeric(levels(CompleteContracts$ObligatedAmountIsCombination))[
        CompleteContracts$ObligatedAmountIsCombination]
...
CompleteContracts$FixedOrCost[CompleteContracts$pIsFixedPrice>0  |
                                  ...
                                  CompleteContracts$pIsCombination>0]<-"Combination \nor Other"
...
CompleteContracts$FixedOrCost<-factor(CompleteContracts$FixedOrCost,levels=c("Fixed-Price","Cost-Based","Combination \nor Other"))
...
NASimpleArea<-(CompleteContracts$SimpleArea=="Mixed or Unlabeled" | is.na(CompleteContracts$SimpleArea))&
    !is.na(CompleteContracts$UnmodifiedSimpleArea)
...
CompleteContracts$PlatformPortfolio.sum[CompleteContracts$pIsEnC>=0.75&
                                            CompleteContracts$PlatformPortfolio.sum=="Unlabeled"]<-"Electronics and Communication
s"
...
CompleteContracts$Comp[CompleteContracts$UnmodifiedIsSomeCompetition=="No Comp."]<-0
CompleteContracts$Comp[CompleteContracts$UnmodifiedIsSomeCompetition=="Comp." & 
                           CompleteContracts$UnmodifiedIsFullAndOpen=="Not Full \n& Open"]<-1
CompleteContracts$Comp[CompleteContracts$UnmodifiedIsSomeCompetition=="Comp." & 
                           CompleteContracts$UnmodifiedIsFullAndOpen=="Full & Open"]<-2
...
```{r Detailed}
CompleteModelAndDetail<-subset(CompleteContracts,select=c(IsIDV,
    FixedOrCost,
    UnmodifiedIsSomeCompetition,
    #                                 Comp,
    qLinked,
