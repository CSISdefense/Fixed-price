...
CompleteContracts$LabeledMDAP[!is.na(CompleteContracts$unmodifiedSystemequipmentcode)]<-"Labeled MDAP"
CompleteContracts$LabeledMDAP[is.na(CompleteContracts$unmodifiedSystemequipmentcode)]<-"No label"
if(!is.factor(CompleteContracts$LabeledMDAP)){
    CompleteContracts$LabeledMDAP<-factor(CompleteContracts$LabeledMDAP,levels=c("Labeled MDAP","No label"))
}
summary(CompleteContracts$LabeledMDAP)
...
CompleteContracts$qLowCeiling <- cut2(CompleteContracts$UnmodifiedContractBaseAndAllOptionsValue,cuts=lowroundedcutoffs)
CompleteContracts$qHighCeiling <- cut2(CompleteContracts$UnmodifiedContractBaseAndAllOptionsValue,cuts=highroundedcutoffs)
...
CompleteContracts$pChangeOrderUnmodifiedBaseAndAll[is.na(CompleteContracts$pChangeOrderUnmodifiedBaseAndAll)&
                                            CompleteContracts$SumOfisChangeOrder==0]<-0


CompleteContracts$qCRais <- cut2(
    CompleteContracts$pChangeOrderUnmodifiedBaseAndAll,c(
                                              -0.001,
                                              0.001,
                                              0.15)
    )
...
if (all(levels(CompleteContracts$qHighCeiling)==c("[0.00e+00,1.50e+04)",
                                              "[1.50e+04,1.00e+05)",
                                              "[1.00e+05,1.00e+06)",
                                              "[1.00e+06,1.00e+07)",
                                              "[1.00e+07,7.50e+07)",
                                              "[7.50e+07,3.36e+12]"))){
    CompleteContracts$qHighCeiling<-factor(CompleteContracts$qHighCeiling, 
...
if (all(levels(CompleteContracts$qLowCeiling)==c("[0.00e+00,1.50e+04)",
                                              "[1.50e+04,1.00e+05)",
                                              "[1.00e+05,1.00e+06)",
                                              "[1.00e+06,3.00e+07)",
                                              "[3.00e+07,3.36e+12]"))){
    CompleteContracts$qLowCeiling<-factor(CompleteContracts$qLowCeiling, 
...
CompleteContracts$SubCustomer.sum<-droplevels(CompleteContracts$SubCustomer.sum)
...
colnames(CompleteModel)[colnames(CompleteModel)=="qLowCeiling"]<-"LowCeil"
colnames(CompleteModel)[colnames(CompleteModel)=="qHighCeiling"]<-"Ceil"
...
colnames(CompleteModel)[colnames(CompleteModel)=="LabeledMDAP"]<-"MDAP"
colnames(CompleteModel)[colnames(CompleteModel)=="qNChg"]<-"NChg"
colnames(CompleteModel)[colnames(CompleteModel)=="qCRais"]<-"CRai"
...
```{r DetailedOutput}
CompleteModelAndDetail<-CompleteContracts
